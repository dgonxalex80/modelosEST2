...
### 1. <span style="color:#034a94">**Examinar la matriz de correlaciones entre las predictoras:**</span> 
...
### 2. <span style="color:#034a94">**Factores de Inflación de Varianza:**</span> 
...
### 3. <span style="color:#034a94">**Análisis de los valores propios de $\boldsymbol{X}'\boldsymbol{X}$:**</span> 
...
<span style="color:#034a94">**Proporciones de descomposición de varianza:**</span> denotados $\pi_{ij}$ representan la proporción de la varianza de cada $\widehat\beta_j$ (o de cada factor de inflación de varianza) debida al $i$-ésimo valor propio de la matriz $\boldsymbol{X}'\boldsymbol{X}$.
