---
title: <span style="color:#034a94"> **R - Estimación MCO**</span>
...
El método consiste en tomar una muestra con repetición de la data y con ella estimar el modelo. Los coeficientes estimados son guardados en un vector por cada estimador, al que se le obtiene la media y la desviación estandar.
...
| Coeficiente estimado    | media           | desviación estandar |
|:------------------------|----------------:|--------------------:|  
