...
Antes de empezar revicemos el concepto de estimador y sus propiedades
...
Un estimador es insesgado cuando su valor esperado es igual al parametro :
...
Cuando un estimador es sesgado, es decir que su valor esperado no coincide con el parámetro, puede tener la propiedad de consistente, que ocurre cuando al aumentar el tamaño de la miestra el estimador se convierte en insesgado como por ejemplo:
