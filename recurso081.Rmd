...
1. <span style="color:#034a94">**El método de recolección de los datos.**</spam>, muestras recogidas en un rango reducido de valores.
...
2. <span style="color:#034a94">**Restricciones en el modelo o en la población.**</span> 
...
3. <span style="color:#034a94">**Especificación del modelo.**</span> Por ejemplo, al agregar términos polinomiales a un modelo cuando el rango de la predictora es pequeño.

</br>

4. <span style="color:#034a94">**Un modelo sobredefinido.**</span> Por ejemplo, en investigación médica donde para algunos pocos pacientes se toma una gran cantidad de predictoras. Es decir que posee más variables que observaciones.
